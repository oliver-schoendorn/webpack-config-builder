...
export default class FontLoaderModule extends FileLoaderModule
{
    public static TEST = /webfont\.(ttf|otf|eot|svg|woff(2)?)(\?[a-z0-9]+)?$/

    public constructor(outputDirectory: string, excludeNodeModules: boolean = false)
    {
        super(FontLoaderModule.TEST, outputDirectory, excludeNodeModules)
    }
