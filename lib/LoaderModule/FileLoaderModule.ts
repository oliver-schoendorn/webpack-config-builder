...
export default class FileLoaderModule extends AbstractThreadSafeLoaderModule
{
    ...
    public constructor(test: RegExp, outputDirectory: string, excludeNodeModules: boolean = false)
    {
        super(test, { loader: 'file-loader' }, excludeNodeModules ? /node_modules/ : undefined)
